      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="space-y-5">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              Keep automatic local database backups for the selected window. Manual and
              pre-rekey safety backups are preserved, and remote archive retention is managed
              separately. Backups are compressed with gzip.
            </p>
          </div>
